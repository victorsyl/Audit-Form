...
<img src="images/logo_example.png" alt="test alt attribute" width="100" height="100" border="0" /><img src="tcpdf_box.svg" alt="test alt attribute" width="100" height="100" border="0" /><img src="images/logo_example.jpg" alt="test alt attribute" width="100" height="100" border="0" />
</div>';
...
// create some HTML content
$html = '<h1>MINI BAKERIES (N) LTD</h1>
<h2>BAKERY VISIT CHECKLIST</h2>
<table cellpadding="1" cellspacing="1" border="1" style="text-align:center;">
<tr><td><img src="../supaloaf.png" style="width:80px;height:80px;" /></td></tr>
