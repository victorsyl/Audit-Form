...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="./admin/css/Dummy.css">
    <!-- Boxicons CDN Link -->
      ...
      <div class="leaves-boxes">
        <div class="recent-leaves box">
          ...
          <?php
                    ...
                    $logged_in_user_branch = $_SESSION['user']['branch_id'];
                    $sql = "SELECT * FROM `adminstaffing` INNER JOIN branch ON branch.branch_id=adminstaffing.branch_id WHERE adminstaffing.branch_id = '".$logged_in_user_branch."'";
                            ...
                            while($row = mysqli_fetch_array($result)){
                                echo "<tr>";
                                    ...
                                    echo "<td>";
                                        ...
                                        echo '<a href="./fetch/pdf.php?id='. $row['id'] .'" class="mr-3" title="Download Record" data-toggle="tooltip"><span class="fa fa-download"></span></a>';
